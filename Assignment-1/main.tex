...
$$P(E_1)=0.15  \hspace{1cm}  P(E_2)=0.20$$
$$P(E_3)=0.31  \hspace{1cm}  P(E_4)=0.26$$
$$P(E_5)=0.08$$\\
...
\begin{align*} 
	P(E_1^{\prime} \cap E_5^{\prime}) &= P(E_1 \cup E_5)^{\prime} \\
	&= 1- P(E_1 \cup E_5)\\
	&= 1- \left[P(E_1) + P(E_5) - P(E_1 \cap E_5) \right]\\
	&= 1- \left[ 0.15 + 0.08 - 0 \right]\\
	&= 1- 23\\
	&= 0.77
\end{align*}
...
\begin{align*} 
	P(E_3 \cup E_2) &= P(E_3) + P(E_2) - P(E_3 \cap E_2)\\
	&= 0.31 + 0.20 - 0\\
	&= 0.51
\end{align*}
...
\begin{align*} 
	P(E_3 \cup E_4) &= P(E_3) + P(E_4) - P(E_3 \cap E_4)\\
	&= 0.31 + 0.26 - 0\\
	&= 0.57
\end{align*}
