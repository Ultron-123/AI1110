...
$$\pr{E_1}=0.15  \hspace{1cm}  \pr{E_2}=0.20$$
$$\pr{E_3}=0.31  \hspace{1cm}  \pr{E_4}=0.26$$
$$\pr{E_5}=0.08$$\\
\noindent Here if you notice one thing, the events are \textbf{Disjoint} because we are talking about surgeries then it can be very-complex or complex but it cannot be very-complex and complex at the same time.\\

\noindent $\implies$ These events are \textbf{Disjoint} to each other and intersection of these events is $0$\\

\noindent We have this \textbf{Axiom} in Probability that\\
 Lets say $A$ and $B$ are two events and
if (\textbf{Intersection})$AB=0$ 
...
\begin{align*} 
	\pr{E_1 + E_2} &= \pr{E_1} + \pr{E_2}   \hspace{1cm}\because E_1E_2=0\\
	&= 0.15 + 0.20 \\
	&= 0.35
\end{align*}
...
\begin{align*} 
	...
	&= 1- \pr{E_1 + E_5}\\
	&= 1- \left[\pr{E_1} + \pr{E_5} \right] \hspace{1cm}\because E_1E_5=0\\
...
\begin{align*} 
	\pr{E_3 + E_2} &= \pr{E_3} + \pr{E_2} \hspace{1cm}\because E_3E_2=0\\
	&= 0.31 + 0.20 \\
	&= 0.51
\end{align*}
...
\begin{align*} 
	\pr{E_3 + E_4} &= \pr{E_3} + \pr{E_4} \hspace{1cm}\because E_3E_4=0\\
	&= 0.31 + 0.26 \\
	&= 0.57
\end{align*}
