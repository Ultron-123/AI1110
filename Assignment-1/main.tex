...
\newgeometry{vmargin={20mm}, hmargin={25mm,25mm}}   % set the margins
...
\begin{align*} 
	...
	&= 1- \pr{E_1 + E_5}\\
	&= 1- \left[\pr{E_1} + \pr{E_5} \right] \hspace{0.45cm} \because E_1E_5=0\\
...
\begin{align*} 
	\pr{E_3 + E_2} &= \pr{E_3} + \pr{E_2} \hspace{0.5cm}\because E_3E_2=0\\
	&= 0.31 + 0.20 \\
	&= 0.51
\end{align*}
...
\begin{align*} 
	\pr{E_3 + E_4} &= \pr{E_3} + \pr{E_4} \hspace{0.5cm}\because E_3E_4=0\\
	&= 0.31 + 0.26 \\
	&= 0.57
\end{align*}
